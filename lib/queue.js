...
Queue.prototype.getAvailableWorker = function getAvailableWorker() {
  for(var i = 0, c = this.workers.length; i < c; i += 1) {
    if(this.workers[i].state === Worker.STOPPED && this.workers[i].available) {
